...
// Interface for ChatView ref to expose switchMode method
export interface ChatViewRef {
	switchMode: (mode: string) => void
}

const ChatView = forwardRef<ChatViewRef, ChatViewProps>(
	({ isHidden, showAnnouncement, hideAnnouncement, showHistoryView }: ChatViewProps, ref) => {
		const {
			version,
	...
	*/
		...
		// Expose switchMode method to parent component
